...
namespace banHangProject.WareManager.Label {
    public partial class frmProvider : Form {
        ...
        private void frmProvider_Load(object sender, EventArgs e) {
            ...
            // Get data
            if (myProviderList != null)
                myProviderList = null;
            myProviderList = new List<Model.Provider>();
            string strCmd = "select * from NCC";
            ...
            foreach (Model.Provider p in myProviderList) {
        ...
        private void cmsEditMenu_Click(object sender, EventArgs e) {
            ...
            frmEditProvider frmEdit = new frmEditProvider(curIdString, curName, curAdd, curPhone);
